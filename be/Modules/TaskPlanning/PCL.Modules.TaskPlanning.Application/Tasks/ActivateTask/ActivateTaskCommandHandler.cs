...
{
    internal sealed class ActivateTaskCommandHandler(
        ITaskRepository repository,
        IUnitOfWork unitOfWork) : ICommandHandler<ActivateTaskCommand>
    {
        public async Task<Result> Handle(ActivateTaskCommand request, CancellationToken cancellationToken)
        {
            ...
            Result result = task.Activate(request.ActivatedAt);
