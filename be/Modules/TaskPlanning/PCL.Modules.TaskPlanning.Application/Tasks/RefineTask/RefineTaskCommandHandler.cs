...
{
    internal sealed class RefineTaskCommandHandler(
        ITaskRepository repository,
        IUnitOfWork unitOfWork) : ICommandHandler<RefineTaskCommand>
    {
        public async Task<Result> Handle(RefineTaskCommand request, CancellationToken cancellationToken)
        {
            ...
            Result result = task.Refine(request.Title, request.Description, request.UpdatedAt);
