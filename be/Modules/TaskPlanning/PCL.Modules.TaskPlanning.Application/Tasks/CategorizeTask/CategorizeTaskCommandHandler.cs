...
{
    internal sealed class CategorizeTaskCommandHandler(
        ITaskRepository repository,
        IUnitOfWork unitOfWork) : ICommandHandler<CategorizeTaskCommand>
    {
        public async Task<Result> Handle(CategorizeTaskCommand request, CancellationToken cancellationToken)
        {
            ...
            Result result = task.Categorize(request.Category, request.UpdatedAt);
